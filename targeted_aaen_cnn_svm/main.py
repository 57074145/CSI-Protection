...
protect_type_num = 10  # The total number of categories
...
attack_target = 7 # targeted label
...
target_1_train_y[target_1_train_y == 0] = -1 
target_1_test_y[target_1_test_y == 0] = -1 
target_2_train_y[target_2_train_y == 0] = -1 
target_2_test_y[target_2_test_y == 0] = -1 
target_3_train_y[target_3_train_y == 0] = -1 
target_3_test_y[target_3_test_y == 0] = -1 
