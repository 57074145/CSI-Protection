...
rerank_holder = tf.placeholder(tf.float32, [None, 7]) # In this untargeted protection, the param is disabled
...
attack_target = 2 # In this untargeted protection, the param is disabled
...
def test():
    ...
    with tf.Session() as sess:
        ...
        show_ori = reverse_norm(batch_xs,  train_x_max, train_x_min) #denormalization 
