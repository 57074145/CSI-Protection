...
class BasicAE:
    ...
    def weights(self):
        _weights = {
            ...
            'W_conv8': ne.weight_variable([3, 3, 48, 48], name='W_conv8'),
            'W_conv9': ne.weight_variable([3, 3, 48, 1], name='W_conv9')
    ...
    def prediction(self):
        ...
        h_conv8 = tf.nn.relu(
            ...
            self.biases['b_conv8'])
       # h_conv9 = ne.conv2d(h_conv8, self.weights['W_conv9']) + self.biases['b_conv9']
        h_conv9 = tf.nn.tanh(
            ne.conv2d(h_conv8, self.weights['W_conv9']) +
            self.biases['b_conv9'])
        return tf.reshape(h_conv9, [-1, 1800])
