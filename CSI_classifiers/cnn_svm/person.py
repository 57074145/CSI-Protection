...
train_y = np.transpose(data['train_per'][:])
test_y = np.transpose(data['test_per'][:])
...
for i in range(0,max_iter):
    ...
    if (i+1) % 100 == 0: 
        saver.save(sess, "person/cnn_net.ckpt", i)      
